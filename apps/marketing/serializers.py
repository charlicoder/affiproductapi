...
class EmailSubscriptionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'email',
            'subscription_type', 'status', 'frequency', 'subscribed_at',
            'is_verified', 'source'
        ]
...
class EmailSubscriptionCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = EmailSubscription
        fields = [
            'email', 'subscription_type', 'frequency', 'source', 'agree_to_terms'
        ]
...
class EmailCampaignSerializer(serializers.ModelSerializer):
    class Meta:
        model = EmailCampaign
        fields = '__all__'
        read_only_fields = ['total_recipients', 'delivered_count', 'opened_count', 'clicked_count']
